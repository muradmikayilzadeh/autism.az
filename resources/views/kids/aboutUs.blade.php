        ...
        <section id="staffHexa" class="col-md-12">
             <div class="container text-center">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-12">
                            ...
                            <p class="about">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos repellendus tenetur atque officiis, doloribus nam aliquam consectetur ipsum eum molestiae sed, quis, voluptatibus. Eum ad, officiis, ullam dignissimos maxime illum!</p>
                        </div>
                        <div class="col-md-3 col-xs-12 col-sm-12">
                            <img src="assets/images/team2.jpg" alt="">
                            <h4>Murad Mikayilzadə</h4>
                            <span class="degree">Web Developer</span>
                            <p class="about">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo praesentium possimus velit ad maiores doloremque facilis, nemo reiciendis quo pariatur eius sint, earum, modi provident quasi totam amet deleniti explicabo.</p>
                        </div>
                        <div class="col-md-3 col-xs-12 col-sm-12">
                            <img src="assets/images/team3.jpg" alt="">
                            <h4>Leyla Abbasova</h4>
                            <span class="degree">Web Developer</span>
                            <p class="about">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam iste numquam assumenda praesentium maxime esse, voluptates vel nemo eius ea aliquid enim optio ad nisi ut pariatur animi, deleniti sunt.</p>
                        </div>
                        <div class="col-md-3 col-xs-12 col-sm-12">
